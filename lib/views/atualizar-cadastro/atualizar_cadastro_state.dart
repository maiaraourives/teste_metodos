...
part 'atualizar_cadastro_state.g.dart';

class AtualizarCadastroState = _AtualizarCadastroState with _$AtualizarCadastroState;

abstract class _AtualizarCadastroState with Store {
  @observable
